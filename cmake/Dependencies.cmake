...
if(USE_ROCM)
  ...
  if(PYTORCH_FOUND_HIP)
    ...
    # composable_kernel has no gfx1250/gfx1250-strict support, so
    # aten/src/ATen/CMakeLists.txt filters those archs out of the ck_gemm
    # target's HIP_ARCHITECTURES. When they are the only requested archs that
    # list is empty and CMake fails at generate time with 'HIP_ARCHITECTURES is
    # empty for target "ck_gemm"', so turn CK GEMM off entirely here -- before
    # -DUSE_ROCM_CK_GEMM is added below, since the non-CK TUs guarded by that
    # define (HIPBlas.cpp, HIPHooks.cpp, GroupedBlas.cpp) would otherwise
    # reference symbols the unbuilt ck_gemm target never provides.
    # Mirrors the USE_ROCM_CK_SDPA / USE_MSLK auto-disable pattern in
    # aten/src/ATen/CMakeLists.txt. Remove once the CK submodule supports these archs.
    if(USE_ROCM_CK_GEMM)
      set(_ck_gemm_supported_arches ${PYTORCH_ROCM_ARCH})
      list(REMOVE_ITEM _ck_gemm_supported_arches "gfx1250" "gfx1250-strict")
