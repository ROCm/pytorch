...
# The rocm-core package was only introduced in ROCm 6.4, so we make it optional.
  ...
  if(DEFINED ENV{USE_ROCM} AND "$ENV{USE_ROCM}" STREQUAL "1")
    message(FATAL_ERROR "CANNOT FIND HIP MOUDLE")
  else()
    message(STATUS "HIP module not found. Building without ROCm support.")
  endif()
endif()
