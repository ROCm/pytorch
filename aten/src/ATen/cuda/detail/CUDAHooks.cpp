...
#if 0
// 1) The following two methods are missing from
// the corresponding header because it's behind the upstream.
// 2) `gfx1250` should be involved in these two methods.
