...
size_t parseChosenWorkspaceSize() {
  ...
  /* 32MiB default, 128MiB for gfx942/gfx950/gfx1250/gfx1250-strict */
  const bool gfx942_950_1250 = at::detail::getCUDAHooks().isGPUArch({"gfx942", "gfx950", "gfx1250", "gfx1250-strict"});
