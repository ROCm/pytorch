...
#define CUDASOLVER_GETRF_BUFFERSIZE_ARGTYPES(Dtype)  \
    hipsolverDnHandle_t handle, int m, int n, Dtype* dA, int ldda, int* lwork
...
#define CUDASOLVER_GETRF_ARGTYPES(Dtype)  \
    hipsolverDnHandle_t handle, int m, int n, Dtype* dA, int ldda, Dtype* workspace, int* ipiv, int* info
