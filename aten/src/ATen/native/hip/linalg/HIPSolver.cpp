...
void getrf_bufferSize<double>(
    hipsolverDnHandle_t handle, int m, int n, double* dA, int ldda, int* lwork) {
...
void getrf_bufferSize<float>(
    hipsolverDnHandle_t handle, int m, int n, float* dA, int ldda, int* lwork) {
  TORCH_CUSOLVER_CHECK(
...
void getrf_bufferSize<c10::complex<double>>(
    hipsolverDnHandle_t handle, int m, int n, c10::complex<double>* dA, int ldda, int* lwork) {
...
void getrf_bufferSize<c10::complex<float>>(
    hipsolverDnHandle_t handle, int m, int n, c10::complex<float>* dA, int ldda, int* lwork) {
...
template <>
void getrf<double>(
    hipsolverDnHandle_t handle, int m, int n, double* dA, int ldda, double* workspace, int* ipiv, int* info) {
...
template <>
void getrf<float>(
    hipsolverDnHandle_t handle, int m, int n, float* dA, int ldda, float* workspace, int* ipiv, int* info) {
...
void getrf<c10::complex<float>>(
  ...
  TORCH_CUSOLVER_CHECK(hipsolverDnCgetrf(
      ...
      ldda,
      reinterpret_cast<hipComplex*>(workspace),
      ipiv,
      info));
}
...
void xgeev_bufferSize<float>(
    ...
    size_t* workspaceInBytesOnDevice,
    size_t* workspaceInBytesOnHost) {
  TORCH_CUSOLVER_CHECK(hipsolverDnXgeev_bufferSize(
...
void xgeev<float>(
  ...
  TORCH_CUSOLVER_CHECK(hipsolverDnXgeev(
      handle,
      params,
      jobvl,
      jobvr,
...
void xsyevBatched_bufferSize<float>(
    ...
    size_t *workspaceInBytesOnHost,
    int64_t batchSize) {
  TORCH_CUSOLVER_CHECK(hipsolverDnXsyevBatched_bufferSize(
       handle,
       params,
       jobz,
       uplo,
...
void xsyevBatched<float>(
    ...
    int *info,
    int64_t batchSize) {
  TORCH_CUSOLVER_CHECK(hipsolverDnXsyevBatched(
       handle,
       params,
       jobz,
       uplo,
