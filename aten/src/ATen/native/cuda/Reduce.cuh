...
#if ((!defined(USE_ROCM)) || (defined(USE_ROCM) && !(defined(__gfx940__) || defined(__gfx941__) || defined(__gfx942__) || defined(__gfx950__))))
...
#if ((!defined(USE_ROCM)) || (defined(USE_ROCM) && !(defined(__gfx940__) || defined(__gfx941__) || defined(__gfx942__) || defined(__gfx950__)))) // skip fence if store are committed [CMTSTRS]
