...
hiprtcResult hiprtcCreateProgram(hiprtcProgram *prog,
  ...
  TORCH_CHECK(fn, "Can't get hiprtcCreateProgram");
...
hipError_t CUDAAPI hipModuleLaunchKernel(hipFunction_t f,
  ...
  TORCH_CHECK(fn, "Can't get hipModuleLaunchKernel");
...
hipError_t CUDAAPI hipModuleLaunchCooperativeKernel(
  ...
  auto fn = reinterpret_cast<decltype(&hipModuleLaunchCooperativeKernel)>(
      getCUDALibrary().sym(__func__));
  TORCH_CHECK(fn, "Can't get hipModuleLaunchCooperativeKernel");
...
hipError_t CUDAAPI hipModuleLoadDataEx(hipModule_t *module,
  ...
  TORCH_CHECK(fn, "Can't get hipModuleLoadDataEx");
...
hipLinkAddData(CUlinkState state,
  ...
  TORCH_CHECK(fn, "Can't get hipLinkAddData");
