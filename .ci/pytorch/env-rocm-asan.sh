...
# detect_container_overflow=0: rocprofiler-sdk has container-overflow bugs we can't fix
export ASAN_OPTIONS=detect_leaks=0:detect_stack_use_after_return=1:symbolize=1:detect_odr_violation=0:detect_container_overflow=0
