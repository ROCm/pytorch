...
class ROCmConfigHeuristic(BaseConfigHeuristic):
    ...
    def __init__(self) -> None:
        ...
        self.mm_configs: list[BaseConfig] = [
            ...
            ROCmGemmConfig(32, 32, 16, 2, 4, group_m=1, waves_per_eu=2, kpack=1),
            ROCmGemmConfig(16, 16, 256, 2, 4, group_m=1, waves_per_eu=2, kpack=1),
            ROCmGemmConfig(16, 16, 128, 3, 4, group_m=1, waves_per_eu=3, kpack=1),
            ROCmGemmConfig(16, 16, 256, 2, 4, group_m=1, waves_per_eu=3, kpack=1),
            ROCmGemmConfig(16, 16, 256, 2, 4, group_m=1, waves_per_eu=2, kpack=1),
            ROCmGemmConfig(64, 64, 32, 2, 4, group_m=2, waves_per_eu=2, kpack=1),
            ROCmGemmConfig(64, 64, 64, 2, 4, group_m=1, waves_per_eu=3, kpack=1),
            ROCmGemmConfig(64, 64, 64, 2, 4, group_m=1, waves_per_eu=2, kpack=1),
            ROCmGemmConfig(16, 16, 256, 2, 4, group_m=2, waves_per_eu=3, kpack=1),
            ROCmGemmConfig(16, 16, 128, 2, 4, group_m=2, waves_per_eu=2, kpack=1),
            ROCmGemmConfig(16, 16, 256, 2, 4, group_m=2, waves_per_eu=2, kpack=1),
            ROCmGemmConfig(16, 16, 128, 3, 4, group_m=1, waves_per_eu=0, kpack=1),
            ROCmGemmConfig(16, 16, 128, 3, 4, group_m=1, waves_per_eu=0, kpack=1),
            ROCmGemmConfig(16, 128, 64, 2, 8, group_m=8, waves_per_eu=3, kpack=1),
            ROCmGemmConfig(32, 32, 64, 3, 4, group_m=1, waves_per_eu=0, kpack=1),
            ...
            ROCmGemmConfig(16, 16, 256, 2, 4, group_m=1, waves_per_eu=3, kpack=1),
            ROCmGemmConfig(16, 16, 128, 3, 4, group_m=2, waves_per_eu=3, kpack=1),
        ]
